...
#         ./multicrab -c status -d <work area> (to check job status)
    ...
    config.General.workArea     = 'QCD_2018'
    config.General.transferLogs = False
    config.JobType.pluginName   = 'Analysis' # PrivateMC
    config.JobType.psetName     = 'run_mc_QCD_2018.py'
    ...
    config.Data.outLFNDirBase  = '/store/user/trmishra/QCD_Pt-40toInf_DoubleEMEnriched_2018/'
