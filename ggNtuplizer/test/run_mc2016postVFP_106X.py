...
process.source = cms.Source("PoolSource",
        ...
        '/store/mc/RunIISummer20UL16MiniAODv2/SMS-T5Wg_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/FSUL16_106X_mcRun2_asymptotic_v17-v2/2550000/6F0451B4-5B2A-814C-9111-0877F4183E46.root'
        ))
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_2016postVFP.root'))
...
process.ggNtuplizer.pfMETLabel=cms.InputTag("slimmedMETs")
