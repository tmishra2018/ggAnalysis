...
#         ./multicrab -c status -d <work area> (to check job status)
    ...
    config.General.workArea     = 'ntuples_WW_2016'
    ...
    config.Data.inputDataset   = '/WW_TuneCP5_13TeV-pythia8/RunIISummer20UL16MiniAODv2-106X_mcRun2_asymptotic_v17-v1/MINIAODSIM'
    config.Data.outLFNDirBase  = '/store/user/trmishra/WW_2016/'
