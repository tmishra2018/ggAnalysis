...
#         ./multicrab -c status -d <work area> (to check job status)
    ...
    config.General.workArea     = 'ntuples_WW_2018'
    ...
    config.Data.inputDataset   = '/WW_TuneCP5_13TeV-pythia8/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM'
    config.Data.outLFNDirBase  = '/store/user/trmishra/WW_2018/'
