...
#         ./multicrab -c status -d <work area> (to check job status)
    ...
    config.General.workArea     = 'SMS-TChiWg_mChi-1000_mLSP-1_2016'
    ...
    config.Data.inputDataset   = '/SMS-TChiWg_mChi-1000_mLSP-1_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16MiniAODv2-106X_mcRun2_asymptotic_v17-v3/MINIAODSIM'
