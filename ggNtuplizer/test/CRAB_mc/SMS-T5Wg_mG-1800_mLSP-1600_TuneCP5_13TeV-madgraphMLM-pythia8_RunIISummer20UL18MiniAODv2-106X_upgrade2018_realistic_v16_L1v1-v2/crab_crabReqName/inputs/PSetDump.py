...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL18MiniAODv2/SMS-TChiWG_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/FSUL18_106X_upgrade2018_realistic_v16_L1v1-v2/30000/E6D86B65-5A68-0945-9D2E-E516B9746715.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ggtree_t5wg_2018.root')
)
...
process.p = cms.Path(process.fullPatMetSequenceModifiedMET+process.egammaPostRecoSeq+process.cleanedMu+process.jetCorrFactors+process.slimmedJetsJEC+process.ggNtuplizer)
