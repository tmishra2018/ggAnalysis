...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL16MiniAODv2/SMS-TChiWG_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/FSUL16_106X_mcRun2_asymptotic_v17-v2/2810000/4E5933AB-97BC-6A48-AE51-241E05C5C727.root')
)
...
process.pfMetModifiedMET = cms.EDProducer("RecoMETExtractor",
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('ggtree_2016preVFP.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('106X_mcRun2_asymptotic_v17'),
...
process.patMetModuleSequenceModifiedMET = cms.Sequence(process.pfMetModifiedMET+process.genMetExtractorModifiedMET+process.patJetCorrFactorsReapplyJECModifiedMET+process.patJetsReapplyJECModifiedMET+process.basicJetsForMetModifiedMET+process.jetSelectorForMetModifiedMET+process.cleanedPatJetsModifiedMET+process.metrawCaloModifiedMET+process.pfCHS+process.pfMetCHS+process.patCHSMet+process.pfTrk+process.pfMetTrk+process.patTrkMet+process.patPFMetModifiedMET)
